...
e.g. the [vt100][], the design patterns had taken root: _searching and
...
And in teach one `touch` a file called "visited."  Visit each directory using
...
* As you work on bigger applications you may want to add director
* Cool points
