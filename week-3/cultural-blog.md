...
In your [USERNAME].github.io/blog directory, copy your blog template into a new HTML file named `c3-thinking-style.html`. (Note: the number corresponds to the week rather than the actual assignment).
